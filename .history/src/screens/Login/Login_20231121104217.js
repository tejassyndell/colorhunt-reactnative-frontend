...
const Login = (props) => {
  ...
  useEffect(() => {
    ...
    const getTokenAndSubscribe = async () => {
      ...
      // Create the channel
      // Expo does not use PushNotification.createChannel
      // Handle it using expo-notifications
      // Assume the channel is already created in the app.json

      // Add logic to handle incoming FCM messages
  ...
  const keyboardDidShow = () => {
    // Your keyboard show logic
  };

  const keyboardDidHide = () => {
    // Your keyboard hide logic
  };
