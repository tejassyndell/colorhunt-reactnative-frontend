...
const AddToCart = (props) => {
  ...
  const handleProceedToCheckout = () => {
    // Extract article_ids from array_1 for faster lookup
    const articleIdsSet = new Set(array_1.map((item) => parseInt(item)));

    // Filter orderItems based on article_ids
    const new_arr = orderItems.filter((it) =>
      articleIdsSet.has(parseInt(it.article_id))
    );
              ...
              <ScrollView nestedScrollEnabled={true}>
                ...
                >
                  ...
                  >
                              ...
                              array_1.includes(item.article_id) ? (
                                ...
                                >
                                  <TouchableOpacity
                                    style={{
                                      width: windowwidthe >= 720 ? 150 : 100,
                                      height: windowwidthe >= 720 ? 140 : 114,
                                      borderRadius: 12,
                    ...
                    <View style={{ width: "100%" }}>
                      <View
                        style={{ marginHorizontal: "3%", marginVertical: 15 }}
                      >
                        <TextInput
                          value={promoCode}
                ...
                <>
                  ...
                  <View style={{ padding: "2.5%" }}>
                    ...
                    >
                      ...
                      <View
                        style={{
                          width: windowwidthe < 720 ? windowwidthe * 0.08 : 50,
                          height: windowwidthe < 720 ? geticondeHeighte() : 50,
                          position: "absolute",
                          top: "50%",
                          right: "3%",
                        }}
