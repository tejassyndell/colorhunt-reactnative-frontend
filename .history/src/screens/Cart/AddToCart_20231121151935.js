        ...
        >
          ...
          >
            <View style={{ width: "100%", backgroundColor: "#FFF" }}>
              <ScrollView nestedScrollEnabled={true} style={{ height: "auto" }}>
                <View
                  style={{
                    width: "100%",
                    backgroundColor: "#FFF",
                        ...
                        array_1.length > 0 ? (
                          ...
                          >
                            <TouchableOpacity
                              ...
                              onPress={() =>
                                handleEditOrder(item.article_id, item.Quantity)
                              }
                            >
                              <Image
                                style={{
                            ...
                            >
                              <View style={{ height: "60%", paddingBottom: 1 }}>
                                <Text
                                  style={{
                                    fontSize: windowwidthe * 0.035,
                                    fontFamily: isFontLoaded
