...
const AddToCart = (props) => {
  ...
  const deletsvg = <Svg width="100%" height="100%" viewBox="0 0 15 17" fill="none">
    <Path
      fill-rule="evenodd"
      clip-rule="evenodd"
                ...
                <View style={{ padding: "2.5%" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      ></Image> */}
                      <Svg width="100%" height="100%" viewBox="0 0 30 30" fill="none" {...props}>
                        <G id="arrow">
                          <G id="BG">
                            <Rect id="Rectangle_45" width={30} height={30} rx={7} fill="white" />
                          </G>
                          <G id="icon">
                            <Path
                              id="Vector"
